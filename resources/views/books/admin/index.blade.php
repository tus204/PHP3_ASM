                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex align-items-center list-user-action">
                                                            <a class="bg-primary" data-toggle="tooltip" style="width: 34px;height: 32px;" data-placement="top" title="Edit" href="{{route('books.edit', $book->id)}}"><i class="ri-pencil-line"></i></a>
