                            ...
                            <div class="iq-card-body">
                                <form action="{{ route('books.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="image-preview" src="#" alt="Image Preview" style="max-width: 100px; margin-bottom: 10px; display: none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="totalBook" aria-describedby="totalBook" name="totalBook">
                                        @error('totalBook')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" id="description" aria-describedby="description" name="description"></textarea>
                                        <small id="char-count" class="form-text text-muted">Character count: 0</small>
                                        @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
